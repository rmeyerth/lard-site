...
| STRICT_SYNTAX      | Boolean | It is strongly recommended to keep this setting enabled along with using the [Reference Token](tokens/references.md). Without this the lexer will allow unknown values to be accepted which could cause unxepected results.
