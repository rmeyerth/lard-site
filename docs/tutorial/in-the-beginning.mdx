...
:::
In the beginning there was nothing... or in our case **null**. Unfortunately, since we haven't defined what null is we
don't even have that yet! We can test this by typing null in our runner app:
```
