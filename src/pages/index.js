      ...
      <div className="container">       
          <div className="myContainer">          
              <div className="invisibleBox"></div>
                <div>
                  <div className="testHeader"><img style={{paddingLeft: 5, width: 70, height: 25, float: "left"}} src={'img/buttons.png'} />&nbsp;&nbsp;<img style={{paddingTop: 5, width: 15, height: 20}} src={'img/icon.svg'} />&nbsp;Language Architect and Runtime Framework - DSL++</div>
